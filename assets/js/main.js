...
pfVideo6.fromTo(".pf-video-6-area" ,  {  clipPath: "polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)",	duration: 1 }, {  clipPath: "polygon(0 0, 100% 0, 100% 100%, 0% 100%)",	duration: 1 })
...
if($(".pf-blog-6-active").length) {
	...
	let pft5img = new Swiper(".pf-blog-6-active", {
		loop: true,
		spaceBetween: 32,
		speed: 500,
